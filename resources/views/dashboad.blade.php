            ...
            <ul class="p-0 m-0">
              <li class="mb-3 pb-1 d-flex">
                <div class="d-flex w-50 align-items-center me-3">
                  <img
                    src="{{asset('public')}}/assets/img/icons/brands/laravel-logo.png"
                    alt="laravel-logo"
                    class="me-3"
                    width="35"
                  />
              ...
              <li class="mb-3 pb-1 d-flex">
                <div class="d-flex w-50 align-items-center me-3">
                  <img
                    src="{{asset('public')}}/assets/img/icons/brands/figma-logo.png"
                    alt="figma-logo"
                    class="me-3"
                    width="35"
                  />
              ...
              <li class="mb-3 pb-1 d-flex">
                <div class="d-flex w-50 align-items-center me-3">
                  <img
                    src="{{asset('public')}}/assets/img/icons/brands/vue-logo.png"
                    alt="vue-logo"
                    class="me-3"
                    width="35"
                  />
              ...
              <li class="mb-3 pb-1 d-flex">
                <div class="d-flex w-50 align-items-center me-3">
                  <img
                    src="{{asset('public')}}/assets/img/icons/brands/react-logo.png"
                    alt="react-logo"
                    class="me-3"
                    width="35"
                  />
              ...
              <li class="mb-3 pb-1 d-flex">
                <div class="d-flex w-50 align-items-center me-3">
                  <img
                    src="{{asset('public')}}/assets/img/icons/brands/bootstrap-logo.png"
                    alt="bootstrap-logo"
                    class="me-3"
                    width="35"
                  />
              ...
              <li class="d-flex">
                <div class="d-flex w-50 align-items-center me-3">
                  <img
                    src="{{asset('public')}}/assets/img/icons/brands/sketch-logo.png"
                    alt="sketch-logo"
                    class="me-3"
                    width="35"
                  />
                ...
                <tr>
                  <td>
                    <div class="d-flex justify-content-start align-items-center">
                      <div class="me-3">
                        <img src="{{asset('public')}}/assets/img/icons/payments/visa-img.png" alt="Visa" height="30" />
                      </div>
                      <div class="d-flex flex-column">
                ...
                <tr>
                  <td>
                    <div class="d-flex justify-content-start align-items-center">
                      <div class="me-3">
                        <img
                          src="{{asset('public')}}/assets/img/icons/payments/master-card-img.png"
                          alt="Visa"
                          height="30"
                        />
                      </div>
                ...
                <tr>
                  <td>
                    <div class="d-flex justify-content-start align-items-center">
                      <div class="me-3">
                        <img
                          src="{{asset('public')}}/assets/img/icons/payments/american-express-img.png"
                          alt="Visa"
                          height="30"
                        />
                      </div>
              ...
              <li class="timeline-item timeline-item-transparent ps-4">
                ...
                <div class="timeline-event">
                  ...
                  <p class="mb-2">
                    ...
                    <img
                      src="{{asset('public')}}/assets/img/avatars/4.png"
                  ...
                  <div class="d-flex flex-wrap gap-2 pt-1">
                    <a href="javascript:void(0)" class="me-3">
                      <img
                        src="{{asset('public')}}/assets/img/icons/misc/doc.png"
                        alt="Document image"
                        width="15"
                        class="me-2"
                      />
                    ...
                    <a href="javascript:void(0)">
                      <img
                        src="{{asset('public')}}/assets/img/icons/misc/xls.png"
                        alt="Excel image"
                        width="15"
                        class="me-2"
                      />
